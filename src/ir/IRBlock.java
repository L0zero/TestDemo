...
public class IRBlock {
    ...
    private static final HashMap<String, IRBlock> endingBlocks = new HashMap<>();

    public static void setEndingBlock(String name, IRBlock irBlock) {
        endingBlocks.put(name, irBlock);
    }
    ...
    public static void printAns(OutputSystem system) {
        ...
        endingBlocks.get("main").output(system);
        ...
        for (String name : funcs.keySet()) {
            ...
            endingBlocks.get(name).output(system);
        }
    }
